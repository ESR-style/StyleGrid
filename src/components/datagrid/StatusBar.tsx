...
export const StatusBar: React.FC<StatusBarProps> = () => {
  ...
  return (
    <div className="ag-status-bar flex items-center justify-between flex-wrap gap-x-6 gap-y-1 px-3 py-1 border-t border-gray-200 bg-gray-50 text-[11px] text-gray-600">
